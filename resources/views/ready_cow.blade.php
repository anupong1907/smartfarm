...
<div class="page-header">
	<div class="page-title">
		<h3 style="font-family: 'Prompt', sans-serif; font-size: 36px; color: #5F6A6A;">โคพร้อมจำหน่าย <span style="font-size: 14px;">ระบบจัดการประชากรโค</span></h3>
	</div>
...
<div class="breadcrumb-line">
	<ul class="breadcrumb">
		...
		<li class="active">โคพร้อมจำหน่าย</li>
	</ul>
...
<div class="form-group">
	<div class="row">
		<div class="col-md-9" style="border-right:1px solid #EBEDEF;">
			<div class="form-group">
				<span class="label label-primary">คำอธิบาย</span> <span style="color: #E74C3C;"><i class="icon-female"></i></span> โคเพศเมีย &nbsp;&nbsp;<span style="color: #3498DB;"> <i class="icon-male"></i></span>  โคเพศผู้ &nbsp; (โคพร้อมจำหน่าย : 1ปี 6 เดือนเป็นต้นไป)
			</div>
			<div class="form-group">
				<div class="datatable">
					<table class="table table-striped">
						<thead>
							<tr style="color: #fff;">
								...
								<th width="150" style="background-color: #283747; ">รายการ</th>
						...
						<tbody class="center">
							@foreach($cow as $list)
							@if(Carbon::parse($list-> cow_dob)->diff(Carbon::now())->format('%y%m') > '16'  )
							<tr>
