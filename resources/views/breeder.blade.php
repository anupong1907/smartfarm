...
<div class="form-group">
	<div class="row">
		<div class="col-md-9" style="border-right:1px solid #EBEDEF;">
			<div class="form-group">
				<span class="label label-primary">คำอธิบาย</span> <span style="color: #E74C3C;"><i class="icon-female"></i></span> โคเพศเมีย &nbsp;&nbsp;<span style="color: #3498DB;"> <i class="icon-male"></i></span>  โคเพศผู้ &nbsp; (โคพ่อพันธ์ุและแม่พันธ์ุ)
			</div> 
			<div class="datatable">
				<table class="table table-striped">
					<thead style="background-color: #283747;">
						<tr style="color: #fff;">
							...
							<th width="130" style="background-color: #283747; ">รายการ</th>
					...
					<tbody class="center">
						...
						<tr>
							...
							<td><a href="{{url('profile_cow/'.$data->cow_id)}}">{{$data->qrcode}} - {{$data->cow_name}}</a></td>
							<td class="center"><span style="color: #3498DB;"> <i class="icon-male"></i></span></td>
							<td>
							...
							<td class="center">
								<div class="visible-md visible-lg hidden-sm hidden-xs">
									<a href="{{url('profile_cow/'.$data->cow_id)}}" style="color: #1B2631;"><i class="icon-search3"></i></a>&nbsp;&nbsp;
									<a href="#edit_{{$data->cow_id}}" data-toggle="modal" style="color: #1B2631;"><i class="icon-pencil2"></i></a>&nbsp;&nbsp;
									<a href="#delete_{{$data->cow_id}}" data-toggle="modal" style="color: #1B2631;"><i class="icon-remove2"></i></a>
								</div>
							</td>
						</tr>
						@endforeach
						...
						<tr>
							...
							<td><a href="{{url('profile_cow/'.$data->cow_id)}}">{{$data->qrcode}} - {{$data->cow_name}}</a></td>
							<td class="center"><span style="color: #E74C3C;"><i class="icon-female"></i></span></td>
							<td>
								<span class="label label-default"> โคแม่พันธ์ุ </span>
							</td>
							<td class="center">
								{{$data->member_name}}
							</td>
